...
var normalizeURL = function normalizeURL(url) {
  ...
  var normalizedLink = new URL(url).href;
  var withoutFragment = normalizedLink.split('#')[0]; // Remove fragment
  var withoutConsecutiveSlashes = withoutFragment.replace(/([^:])\/{2,}/g, '$1/'); // Replace consecutive slashes with a single slash
  var trimmedLink = withoutConsecutiveSlashes.replace(/\/+$/, ''); // Remove trailing slashes
  return trimmedLink;
};
var crawlDomain = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          crawl = /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, currentDepth) {
              var normalizedURL, instance, response, $, links, absoluteLinks, filteredLinks, normalizedLinks, requests, limitedRequests, _normalizedURL;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 9:
                    ...
                    absoluteLinks = links.map(function (link) {
                      if (link.startsWith('http://') || link.startsWith('https://')) {
                        return link; // Already an absolute URL, no need to convert
                      } else {
                        var baseUrlObj = new URL(url);
                        var absoluteURL = baseUrlObj.origin + "/" + link; // Convert relative URL to absolute URL
                        return absoluteURL;
                      }
                    });
                    filteredLinks = absoluteLinks.filter(function (link) {
                      try {
                    ...
                    normalizedLinks = filteredLinks.map(function (link) {
                    ...
                    requests = normalizedLinks.filter(function (link) {
                      return !visitedUrlsSet.has(normalizeURL(link));
  ...
  return function crawlDomain(_x) {
